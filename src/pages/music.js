...
class MusicPage extends Component {
  render() {
    const performingImage = this.props.data.performingImage.childImageSharp.fluid;
    return (
      <Layout>
        <SEO title="Music" />
        <MainContainer>
          ...
          <iframe width="100%" height="166" scrolling="no" frameBorder="no" allow="autoplay" title="7" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/515944287&color=%235330eb&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
        </MainContainer>
      </Layout>
    )
  }
